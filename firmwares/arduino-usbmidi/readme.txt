To setup the project and upload the Arduino usbmidi application firmware to an ATMEGA8U2 using the Arduino USB DFU bootloader:
...
Check that the board enumerates as "Arduino MIDI".
